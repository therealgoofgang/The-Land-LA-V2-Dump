...
Config.HuntingZones = {
    ["CHILIAD_MOUNTAINS"] = {
        ...
        allowedWeapons = { "WEAPON_SNIPERRIFLE", "WEAPON_SNIPERRIFLE" }, -- nil if you want to allow every weapon
        zone_radius = {
            enable = true,
            color = 1,
            opacity = 128,
        ...
        animals = {
            {
                ...
                harvestTime = 5,
                harvestWeapons = { "WEAPON_SNIPERRIFLE" },
                blip = {
                    enable = true,
                    name = 'Deer',
                    type = 119,
...
Config.Shops = {
    ["HuntGear Store"] = {
        coords = vector4(2016.9908, 4987.8306, 41.0982, 136.8616),
        ped = {
