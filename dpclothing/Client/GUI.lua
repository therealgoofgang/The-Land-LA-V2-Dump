...
Citizen.CreateThread(function()
	-- Load required texture dictionaries
...
-- Command to toggle the clothing menu
RegisterCommand("clothing", function()
	local ped = PlayerPedId()
	if not Check(ped) then return end
...
-- Default keybind (player can rebind in GTA V Settings > Key Bindings > FiveM)
RegisterKeyMapping("clothing", "Open clothing menu", "keyboard", "Y")