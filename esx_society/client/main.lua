		...
		options = {
			{
				...
				onSelect = function()
					...
					TriggerServerEvent("core_multijob:promote", data.identifier, society, data.grade)
				end,
			},
			{
			...
			},
			{
				...
				onSelect = function()
					...
					TriggerServerEvent("core_multijob:removeJobSociety", data.identifier, society, data.grade)
				end,
			}
		}
	})
