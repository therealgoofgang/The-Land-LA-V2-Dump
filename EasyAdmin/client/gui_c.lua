...
function GenerateMenu() -- this is a big ass function
	...
	if permissions["player.kick"] then
		local thisItem = NativeUI.CreateItem("Teleport to admin center 1", "Teleports You To admin center")
		playermanagement:AddItem(thisItem)
		thisItem.Activated = function(ParentMenu,SelectedItem)
			entity = GetPlayerPed(-1)
			SetEntityCoords(entity, 7400.1538, 7368.4692, 15.5188)
	...
	if permissions["player.kick"] then
	 	local thisItem = NativeUI.CreateItem("Teleport to admin center 2", "Teleports You To admin center 2")
	 	playermanagement:AddItem(thisItem)
	 	thisItem.Activated = function(ParentMenu,SelectedItem)
	 		entity = GetPlayerPed(-1)
	 		SetEntityCoords(entity, 7468.2471, 7443.4604, 12.3360)
	 		ShowNotification("~g~Success")
	 	end
	end

	if permissions["player.kick"] then
	 	local thisItem = NativeUI.CreateItem("Teleport to admin center 3", "Teleports You To admin center 3")
	 	playermanagement:AddItem(thisItem)
	 	thisItem.Activated = function(ParentMenu,SelectedItem)
	 		entity = GetPlayerPed(-1)
	 		SetEntityCoords(entity, 7504.6509, 7575.9438, 9.5363)
	 		ShowNotification("~g~Success")
	 	end
	end
