...
function ESX.Progressbar(message, length, Options)
    ...
    print("[^1ERROR^7] ^Progressbar^7 is Missing!")
end

function ESX.ShowNotification(message, notifyType, length)
    lib.notify{ type = notifyType or 'inform', description = message or 'No Message', duration = length or 5000 }
end
...
function ESX.Game.SetVehicleProperties(vehicle, props)
    ...
    if props.fuelLevel ~= nil then
        ...
        exports['nn_fuel']:SetFuel(vehicle, props.fuelLevel + 0.0)
    end
