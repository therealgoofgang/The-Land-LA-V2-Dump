...
local chatLoaded = true -- Assuming the chat is loaded initially, adjust this based on your actual implementation
...
RegisterNUICallback('chatResult', function(data, cb)
  if data and (not data.canceled or (type(data.canceled) == "table" and not data.canceled.isTrusted)) then
    TriggerServerEvent('chatMessageEnteredLogging', data)
  end
...
if not isRDR then
  RegisterCommand('togglechatkey', function()
...
RegisterKeyMapping('togglechatkey', 'Toggle Text Chat', 'keyboard', 'T')
